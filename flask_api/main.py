...
def preprocess_comment(comment):
    ...
    try:
        ...
        print(f'Error while preprocessing the comment: {e}')
        return comment
...
def load_model_and_vectorizer(model_path: str, vectorizer_path: str) -> tuple:
    """Loading model and vectorizer from local machine"""
    try:
        ...
        print(f'Error while loading model and vectorizer: {e}')
        raise
...
def predict():
    ...
    try:
        ...
        return jsonify({'error': f'Error while predicting the comments: {e}'}), 500
