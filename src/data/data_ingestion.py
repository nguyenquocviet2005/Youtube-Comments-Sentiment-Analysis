...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    """Preprocessing data by handling missing values, duplicates and empty strings."""
    try:
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    """Save train and test data, create a new raw folder it it doesn't exist"""
    try:
